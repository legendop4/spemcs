        ...
        <form onSubmit={handleCreateExam} className="ds-flex-col" style={{ gap: '24px' }}>
          ...
          <div className="ds-flex-row" style={{ gap: '16px' }}>
            ...
            <div className="ds-flex-col" style={{ gap: '8px', flex: 1 }}>
              ...
              >
                {/* Firefox is deliberately absent. The endpoint agent's process classifier
                    hard-denies firefox.exe and the signed-policy receiver rejects
                    approved_browser="firefox", so an exam created with it could never be
                    activated - the candidate would simply be locked out. */}
